...
<body>
    ...
    <div class="main-container">
        ...
        <div class="right-panel">
            ...
            <h6 class="fw-bold mb-3 text-primary">FRANCHISE DETAILS</h6>
            <form>
                ...
                <div class="mb-3 form-check">
                    <input class="form-check-input" type="checkbox" id="mainCompany">
                    <label class="form-check-label" for="mainCompany">
                        The Main Company will provide
                    </label>
                </div>

                <div class="mb-3">
                    <label class="form-label small fw-semibold">Preferred Payment Method</label>
                    <div class="d-flex justify-content-between">
                        <button type="button" class="btn btn-cash btn-payment">Cash</button>
                        <button type="button" class="btn btn-bank btn-payment">Bank</button>
                    </div>
                </div>

                <div class="mb-3">
                    <label class="form-label small fw-semibold">Bank Account (If not using e-wallet):</label>
                    <input type="text" class="form-control" placeholder="Bank Account Holder Name">
                </div>

                <div class="d-flex justify-content-between align-items-center mt-4">
                    <a href="1.php" class="btn btn-outline-secondary">Back</a>
                    <div class="step-indicator">2 / 4</div>
                    <a href="3.php" class="btn btn-primary">Next</a>
                </div>
            </form>
        </div>
    </div>
