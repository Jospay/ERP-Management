        ...
        <div class="right-panel">
            ...
            <form>
                <div class="mb-3 input-icon">
                    ...
                    <input type="text" class="form-control" placeholder="Full Name (Owner)">
                </div>
                ...
                <div class="mb-3 input-icon">
                    ...
                    <select class="form-select">
                        <option selected>Driver’s License</option>
                ...
                <div class="mb-3">
                    <label class="form-label">Upload License:</label><br>
                    <button type="button" class="btn btn-outline-secondary btn-sm me-2">Front +</button>
                    <button type="button" class="btn btn-outline-secondary btn-sm">Back +</button>
                </div>

                <div class="d-flex justify-content-between align-items-center mt-4">
                    <div class="step-indicator">1 / 4</div>
                    <a href="2.php" class="btn btn-primary">
                        Next
                    </a>
                </div>
            </form>
